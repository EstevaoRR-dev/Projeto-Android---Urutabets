...
import br.com.testesbottomnav.AreaApostasNba;
 ...
 * Use the {@link BasquetFrag#newInstance} factory method to
 * create an instance of this fragment.
 */
public class BasquetFrag extends Fragment {
     ...
     * @return A new instance of fragment BasquetFrag.
     */
    // TODO: Rename and change types and number of parameters
    public static BasquetFrag newInstance(String param1, String param2) {
        BasquetFrag fragment = new BasquetFrag();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_basquet, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.recycler_view_basquete);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Adapter adapter = new Adapter(getContext(), items, new Adapter.OnClickListener() {
                    ...
                    public void onItemClick(int position) {
                        ...
                        Intent intent = new Intent(getContext(), AreaApostasNba.class);
