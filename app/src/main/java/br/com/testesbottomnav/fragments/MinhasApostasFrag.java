 ...
 * Use the {@link MinhasApostasFrag#newInstance} factory method to
 * create an instance of this fragment.
 */
public class MinhasApostasFrag extends Fragment {
    ...
    public static MinhasApostasFrag newInstance(String param1, String param2) {
        MinhasApostasFrag fragment = new MinhasApostasFrag();
    ...
    private void dataInitialize(View view) {
        ...
        recyclerView = view.findViewById(R.id.recyclerView_minhas_apostas);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));

        db = FirebaseFirestore.getInstance();
        apostasRef = db.collection("apostas");
        query = apostasRef.whereEqualTo("userId", userId);
